  ...
  return (
    ...
    justify-between min-h-[calc(90vh-6rem)]'>
     ...
     md:mt-[60%] lg:mt-0'>
        ...
        from-[#656565] to-[#e99b63] to-[#e99b63]
      ...
      bottom-0 lg:left-[25%] sm:left-[-2%] h-full" scene="https://prod.spline.design/1W0uAXcyE6NX9jCq/scene.splinecode" />
